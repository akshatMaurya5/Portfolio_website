    ...
    <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-20 py-12">
      <div className="w-full md:w-6/12">
        ...
        <p className="text-md text-gray-600 dark:text-gray-300">
          A passionate coder and problem solver who thrives on taking on new
          challenges. With a love for experimentation, they fearlessly dive into
          uncharted territories, pushing the boundaries of their skills. Their
          insatiable curiosity fuels their continuous pursuit of innovative
          solutions. [Your Name] is a true trailblazer, always seeking new
          opportunities to grow and excel in the world of coding and problem
          solving.
        </p>
        <br />
        <button
